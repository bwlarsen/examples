...
pilev2constants = DatasetConstants(
    chars_per_sample=2163,  # Computed over validation set
    chars_per_token=4  # OpenAI estimate
)
pilev2constants.splits['train'] = DataSplitConstants(hf_split='train',
                                                 folder_split='train',
                                                 raw_samples=None,
                                                 truncated_samples=None)
...
CONSTS = {'c4': c4constants, 'the_pile': pileconstants, 
    'bigcode/the-stack-dedup':stackconstants, 'CarperAI/pilev2-dev': pilev2constants}
